...
<head>
    ...
    <link rel="stylesheet" href="styleSuggestMovie.css">
...
<div class="container text-center mt-5 mb-4">
    <form style="width: 400px; margin: auto; padding: 30px;">
        ...
        <input type="number" class="in form-control" placeholder="Year (optional)">
        <input type="text" class="mb-3 finish form-control" placeholder="Description (optional)">
        <div>
