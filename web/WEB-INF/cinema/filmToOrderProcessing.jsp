...
<head>
    ...
    <link rel="stylesheet" href="styleFilmToOrderProcessing.css">
...
<div class="container text-center mt-5">
    <form style="width: 400px; margin: auto; padding: 30px;">
        ...
        <p class="h5 text-primary">Movie name</p>
        <p class="h5 text-primary">Movie year</p>
        <p class="h5 text-primary mb-3">Movie description</p>
        <div>
            <input type="submit" class="btn btn-sm btn-dark" value="Reject movie" style="width: 270px;">
        </div>
    </form>
</div>
...
<div class="container text-center mt-4 mb-4">
    <form style="width: 400px; margin: auto; padding: 30px;">
        ...
        <div>
            <input type="submit" class="btn btn-sm btn-dark" value="Accept movie" style="width: 270px;">
        </div>
    </form>
</div>
